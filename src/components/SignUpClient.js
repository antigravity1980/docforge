            ...
            <section style={s.page}>
                <div style={s.card}>
                    <div style={s.header}>
                        ...
                        <p style={s.subtitle}>{t.magicLink.replace('{email}', email)}</p>
                    </div>
                    <button onClick={() => setSuccess(false)} className="btn btn-secondary" style={{ width: '100%' }}>
                        {t.backToSignUp}
                    </button>
                </div>
            </section>
    ...
    return (
        <section style={s.page}>
            <div style={s.card}>
                ...
                <button style={s.googleBtn} onClick={handleGoogleSignUp} disabled={loading}>
                ...
                <p style={s.footerText}>
                    {t.alreadyAccount} <Link href={`/${locale}/auth/signin`} style={s.link}>{t.signInLink}</Link>
                </p>
                <p style={s.terms}>
                    {t.agree} <Link href={`/${locale}/terms`} style={s.link}>{t.terms}</Link> {t.and} <Link href={`/${locale}/privacy`} style={s.link}>{t.privacy}</Link>.
                </p>
            </div>
        </section>
    );
